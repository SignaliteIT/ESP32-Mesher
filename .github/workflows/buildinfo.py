...
include_file.write("\n")
include_file.write("const BuildEnvironment BuildInfo::buildEnvironment{BuildEnvironment::local};\n")
include_file.write("const BuildType BuildInfo::buildType{BuildType::development};\n")
